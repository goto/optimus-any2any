...
| | PG__MAX_OPEN_CONNECTION | Maximum open connections for source pool. |
| | PG__MIN_OPEN_CONNECTION | Minimum open connections for source pool. |
...
| | HTTP__CLIENT_CREDENTIALS_PROVIDER | (experimental) HTTP client credentials provider, availability: custom_provider_a. (default: "") (optional) |
...
| CONCURRENCY | Concurrency number for all components. (default: 1) |
| SOURCE_CONCURRENCY | Concurrency number for the source. (default: 0; uses CONCURRENCY value) |
| SINK_CONCURRENCY | Concurrency number for the sink. (default: 0; uses CONCURRENCY value) |
| CONNECTOR_CONCURRENCY | Concurrency number for the connector. (default: 0; uses CONCURRENCY value) |
