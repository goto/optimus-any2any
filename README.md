...
| | GMAIL__RESULT_FILENAME_COLUMN | Filename to be appended as part of the record. "" for ignore (default: "__source_file") |
| | GMAIL__COLUMN_MAPPING_FILE_PATH | Path to the mapping column for salesforce record result. "" for ignore |
