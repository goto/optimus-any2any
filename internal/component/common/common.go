...
func (c *Common) Retry(f func() error) error {
	return Retry(c.Core.Logger(), c.retryMax, c.retryBackoffMs, f, func() {
		retryCount, err := c.Meter().Int64Counter(otel.RetryCount, metric.WithDescription("The total number of retries"))
		if err != nil {
...
func (cq *concurrentQueue) submit(fn func() error, hookFuncs ...func()) {
	select {
	case cq.sem <- struct{}{}:
		cq.wg.Add(1)
		go func() {
